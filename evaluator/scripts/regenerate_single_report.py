...
from reporting.collector import TokenUsage, collect  # noqa: E402 — import after sys.path setup
from reporting.render_md import render_markdown  # noqa: E402 — import after sys.path setup

# Use the existing run
run_folder = (
    REPO_ROOT
    / "runs/sci-calc/extension-test/20260309T221909-aidlc-workflows_featextension_hook_question_split-ext-all-extensions"  # noqa: E501
)
...
data.metrics.repeated_context_tokens = TokenUsage(repeated, 0, repeated)
