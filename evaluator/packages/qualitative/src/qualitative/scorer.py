...
2. **Design Similarity**: Are the architectural decisions, component
   structures, and technical approaches similar?
...
{{"intent_similarity": <float>, "design_similarity": <float>,
  "completeness": <float>, "notes": "<brief explanation>"}}
