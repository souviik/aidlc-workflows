...
_PROJECT_MARKERS: list[tuple[str, str, str, str]] = [
    ...
    (
        "pyproject.toml",
        "python",
        'uv pip install -qq -e ".[dev]"',
        "uv run pytest --tb=short -q --no-header -o console_output_style=classic",
    ),
    ...
    (
        ...
        "python-legacy",
        'pip install -e ".[dev]"',
        "python -m pytest --tb=short -q --no-header -o console_output_style=classic",
    ),
]
