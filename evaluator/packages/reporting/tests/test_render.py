    ...
    return ReportData(
        ...
        contracts=ContractResults(
            ...
            cases=[
                ...
                ContractCase(
                    "add positive", "/api/v1/arithmetic/add", "POST", True, 200, 200, latency_ms=8.1
                ),
            ],
        ),
        qualitative=QualitativeResults(
            ...
            phases=[
                PhaseScore(
                    ...
                    documents=[
                        DocScore(
                            "inception/component-dependency.md",
                            1.0,
                            0.95,
                            0.9,
                            0.96,
                        ...
                        DocScore(
                            "inception/component-methods.md", 1.0, 0.95, 0.85, 0.95, "Same methods."
                        ),
                    ],
                ),
                PhaseScore(
                    ...
                    documents=[
                        DocScore(
                            "construction/test-plan.md", 0.9, 0.85, 0.8, 0.85, "Good coverage."
                        ),
                    ],
                ),
            ],
