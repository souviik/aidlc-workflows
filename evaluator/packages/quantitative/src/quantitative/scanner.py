...
def scan_workspace(workspace: Path, pmd_path: str | None = None) -> QualityReport | None:
    ...
    if project_type == "python":
        lint, security, semgrep, duplication = _run_python_analyzers(
            project_root, pmd_path=pmd_path
        )
    ...
    report = QualityReport(
        ...
        project_root=str(project_root.relative_to(workspace)) if project_root != workspace else ".",
        lint=lint,
        security=security,
        semgrep=semgrep,
