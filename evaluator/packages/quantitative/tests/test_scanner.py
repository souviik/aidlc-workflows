...
from quantitative.scanner import _detect_project, scan_workspace, write_report
...
class TestScanWorkspace:
    ...
    def test_python_project(self, tmp_path):
        ...
        mock_lint = ToolResult(
            tool="ruff", version="0.8.0", available=True, exit_code=0, findings=[]
        )
        mock_sec = ToolResult(
            tool="bandit", version="1.7.0", available=True, exit_code=0, findings=[]
        )
